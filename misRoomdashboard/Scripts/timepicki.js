		...
		return this.each(function() {
			...
			var new_ele = $(
				"<div class='timepicker_wrap " + settings.custom_classes + "'>" +
					...
					"<div class='time'>" +
						top_arrow_button +
						"<div class='ti_tx'><input type='text' class='timepicki-input'" + (settings.disable_keyboard_mobile ) + " id='hrs'></div>" +
						bottom_arrow_button +
					"</div>" +
					"<div class='mins'>" +
						top_arrow_button +
						"<div class='mi_tx'><input type='text' class='timepicki-input'" + (settings.disable_keyboard_mobile) + " id='mins'></div>" +
						bottom_arrow_button +
					"</div>");
			if(settings.show_meridian){
				new_ele.append(
			...
			$(".timepicki-input").keydown(function (evt) {
                ...
                var isvalid = true;
					...
					if ($(this).attr('id') == 'hrs' && parseInt($(this).val()) > 23)
					{
					    isvalid = false;
					}
					else if ($(this).attr('id') == 'mins' && parseInt($(this).val()) > 60)
					{
					    isvalid = false;
					}
