...
namespace Rooms.Models
{
    public class VPCRequest
    {
        ...
        public VPCRequest()
        {
            ...
            _merchantID = appSettings["vpc_Merchant"];
            _accessCode = appSettings["vpc_AccessCode"];
            _vpcCommand = appSettings["vpc_Command"];
            _vpcVersion = appSettings["vpc_Version"];
            _returnURL = appSettings["vpc_ReturnURL"];
        ...
        public String SecureSecret { get { return appSettings["SecureSecret"]; } }
